...
export function ProjectOnboarding({
  ...
  function validateStep() {
    if (step === 2) {
      ...
      if (brief.trim().length > 8000) return "Project brief must be 8,000 characters or fewer.";
    }
          ...
          <div className="framework-choice-grid">
            {BUILT_IN_FRAMEWORKS.map((framework, index) => (
              ...
              >
                ...
                {frameworkChoice === framework.id ? <span className="framework-selected-mark" aria-label="Selected"><UiIcon name="Check" /></span> : null}
              </button>
            ))}
            <button
            ...
            >
              ...
              {frameworkChoice === "custom" ? <span className="framework-selected-mark" aria-label="Selected"><UiIcon name="Check" /></span> : null}
            </button>
            <button
            ...
            >
              ...
              {frameworkChoice === "none" ? <span className="framework-selected-mark" aria-label="Selected"><UiIcon name="Check" /></span> : null}
            </button>
          </div>
