        ...
        <svg viewBox="0 0 1000 400" width="100%" height="100%">
          <defs>
            ...
            <g id="mini-floating-rock">
              <polygon points="0,-6 7,-2 5,8 -4,9 -8,2" fill="#334155" />
          ...
          <g className="floating-island-group" style={{ animationDelay: "-2s" }}>
            <g transform={`translate(${islandOffset.x}, ${islandOffset.y}) scale(${islandOffset.scale})`}>
          ...
          <g className="floating-island-group">
            {/* 1. Deep Rocky Crags Base & Earth Soil (Adjustable via islandOffset, Black outlines removed) */}
            <g transform={`translate(${islandOffset.x}, ${islandOffset.y}) scale(${islandOffset.scale})`}>
              <polygon
            ...
            {/* 3. Top Grassy Surface Plateau (Adjustable via greenOffset, Black outlines removed) */}
            <g transform={`translate(${greenOffset.x}, ${greenOffset.y}) scale(${greenOffset.scale})`}>
              <path
